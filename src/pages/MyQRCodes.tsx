  ...
  if (isAdmin && !adminAuth) {
    return (
      <Dialog open={showAdminModal}>
        <DialogContent className="max-w-sm mx-auto p-8 rounded-2xl bg-white border border-gray-300">
          ...
          <form onSubmit={handleAdminPassword} className="space-y-5 mt-4">
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-300 text-gray-900 text-lg focus:outline-none focus:ring-2 focus:ring-[#ff6b00]"
              autoFocus
            />
