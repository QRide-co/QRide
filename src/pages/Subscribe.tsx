...
const Subscribe = () => {
  ...
  if (!qrData) {
    return <div className="min-h-screen flex items-center justify-center text-gray-900">QR code not found.</div>;
  }

  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-gray-100 text-gray-900 flex flex-col items-center justify-center px-4 py-12">
          ...
          <CardContent className="flex flex-col md:flex-row gap-8 items-center justify-center">
            ...
            <div className="flex-1 bg-gradient-to-br from-[#ff6b00]/10 to-gray-50 rounded-2xl p-8 border border-[#ff6b00]/30 shadow-lg flex flex-col items-center">
              ...
              <div className="text-5xl font-extrabold text-gray-900 mb-2 flex items-end gap-2">
                <span>10</span>
                <span className="text-2xl text-gray-600 font-medium">EGP</span>
                <span className="text-lg text-gray-500 font-normal mb-1">/month</span>
              </div>
