      ...
      <div className="w-full max-w-lg mx-auto space-y-8">
        ...
        <Card className="mb-6">
          <CardContent className="p-8 flex flex-col items-center">
            <h2 className="text-2xl font-semibold mb-4 text-gray-900">Buy a Car Sticker</h2>
            ...
            <a href="https://wa.me/201094542810" target="_blank" rel="noopener noreferrer" className="w-full">
              <Button className="w-full bg-[#ff6b00] text-white hover:bg-orange-500 font-bold text-lg py-3 rounded-xl shadow-xl transition-all duration-200 mb-2">
                Order via WhatsApp
              </Button>
            </a>
          </CardContent>
